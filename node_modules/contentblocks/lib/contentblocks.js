...
module.exports = function (params) {
    ...
    return {
        render: function (req, res, next) {
            ...
            if (!init) {
                // Initialize routes.
                console.log('****Setting up controller manager with host: ' + params.host + ' and port:' + params.port);
                ControllerManager.setup(app, params.host, params.port, params.pathPost, params.pathPut, params.pathDelete);
                init = true;
            }
                    ...
                    var webManagerSendSync = function (contentBlockItems, index) {
                        ...
                        if (index < contentBlockItems.length) {
                            ...
                            if (result != null && result.length > 0) {
                                ...
                                WebManager.send(req, res, contentBlockItem.host, contentBlockItem.port, contentBlockItem.path, 'GET', function (result) {
                                    if (result != null && result.length > 0) {
                                        if (params.cache || params.cache == undefined) {
                                            // Cache the result.
